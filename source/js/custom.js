...
(function() {
    ...
    $("head").append("<link rel=\"stylesheet\" type=\"text/css\" href=\"//cdn.jsdelivr.net/gh/Royce2019/BlogSource/css/music.min.css\">");
    dr.append("<div id=\"player\"><div id=\"player-track\"><div id=\"album-name\"></div><div id=\"track-name\"></div><div id=\"track-time\"><div id=\"current-time\"></div><div id=\"track-length\"></div></div><div id=\"s-area\"><div id=\"ins-time\"></div><div id=\"s-hover\"></div><div id=\"seek-bar\"></div></div></div><div id=\"player-content\"><div id=\"album-art\"><img src=\"http://p2.music.126.net/wQ1hODvJ8p8poJEYru-u2w==/109951163597938340.jpg\" class=\"active\" id=\"album-pic\"><div id=\"buffer-box\">加载中...</div></div><div id=\"player-controls\"><div class=\"control\"><div class=\"player-button\" id=\"play-previous\"><i class=\"iconfont icon-backward\"></i></div></div><div class=\"control\"><div class=\"player-button\" id=\"play-pause-button\"><i class=\"iconfont icon-pause\"></i></div></div><div class=\"control\"><div class=\"player-button\" id=\"play-next\"><i class=\"iconfont icon-forward\"></i></div></div></div></div></div>");
