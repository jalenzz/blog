...
"scripts": {
  .......
  "xx": "xxxx",
+  "baidupush": "hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy && hexo deploy"
},
```
