...
以我的[个人主页](https://www.royce2003top)为例，是由 Vue.js 构建的，部署在腾讯云静态网站托管。GitHub 仓库地址：[homepage](https://github.com/royce003/homepage)
...
-  - type: git
-    repo: git@github.com:royce003/test.git
-    branch: master
```
