...
![重装](https://u.jalenz.cn/artalk-api-php/re-install.png?blog)

进入实列进行远程连接，选择 「终端连接」 进行 「密码认证」

![远程连接](https://u.jalenz.cn/artalk-api-php/remote.png?blog)
...
![安全组](https://u.jalenz.cn/artalk-api-php/safe.png?blog)

若没有相关端口的放行则需要手动添加

![放行端口](https://u.jalenz.cn/artalk-api-php/port.png?blog)
...
![删除函数禁用](https://u.jalenz.cn/artalk-api-php/putenv.png?blog)
...
![更改权限](https://u.jalenz.cn/artalk-api-php/authority.png?blog)

在宝塔面板的站点页面添加站点，根目录选择 `ArtalkServePhp`。

![添加站点](https://u.jalenz.cn/artalk-api-php/site.png?blog)

然后在站点的设置中修改运行目录为 `/public`。

![设置运行目录](https://u.jalenz.cn/artalk-api-php/run_directory.png?blog)
